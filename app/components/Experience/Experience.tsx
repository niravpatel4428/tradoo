...
// // import vertexShader from '@/app/components/customShader/vertex.glsl';
// import fragmentShader from '../customShader/fragment.glsl';
// // import fragmentShader from "@/app/components/customShader/fragment.glsl";
...
//   } = useControls('Wave', {
//     uColor1: { value: '#7e94c7' },
//     uColor2: { value: '#1b2f6b' },
//     uColor3: { value: '#000c28' },
//     uNoiseDensity: { value: 0.78, min: 0, max: 10, step: 0.001 },
//     uNoiseStrength: { value: 0.65, min: 0, max: 10, step: 0.001 },
...
//     fogColor: { value: '#DDE6FA' },
//     fogNear: { value: 7, min: 0, max: 50, step: 0.01 },
//     fogFar: { value: 10, min: 0, max: 200, step: 0.01 },
//     deviceDPR: { value: 1.25, min: 0.5, max: 2, step: 0.01 },
//   });
